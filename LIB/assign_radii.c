...
void assign_radii(atom* atoms,resid* residue,int atm_cnt)
{
  ...
  for(int atomi=1; atomi<=atm_cnt; ++atomi) {
    ...
    if(!strncmp(residue[atoms[atomi].ofres].name, "  C", 3) || !strncmp(residue[atoms[atomi].ofres].name, "  G", 3)
       || !strncmp(residue[atoms[atomi].ofres].name, "  A", 3) || !strncmp(residue[atoms[atomi].ofres].name, "  T", 3)
       || !strncmp(residue[atoms[atomi].ofres].name, "  U", 3)) {
