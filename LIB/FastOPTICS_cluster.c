...
{
//    int minPoints = static_cast<int>( floor(nChrom * 0.0025) );
    int minPoints = 10;
 ...
 //    BindingPopulation::BindingPopulation Population4(FA,GB,VC,chrom,gene_lim,atoms,residue,cleftgrid,nChrom);
    ...
    Algo1.Execute_FastOPTICS();
    // Algo2.Execute_FastOPTICS();
    // Algo3.Execute_FastOPTICS();
    // Algo4.Execute_FastOPTICS();
    // Algo5.Execute_FastOPTICS();
